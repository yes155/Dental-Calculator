...
Current HTML pages in `src/` are preview implementation scaffolds. They are not the final editorial copy until Gemini production drafts are returned, audited and integrated by ChatGPT.
