...
for (const token of ["Universal interaction + calculator density contract", "Universal money-input focus contract", ".calculator-card--guided", ".orthodontic-calculator", ".cosmetic-calculator", ".prosthetic-calculator"]) {
