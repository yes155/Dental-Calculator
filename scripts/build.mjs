...
const pageChecks = [
  ...
  },
  {
    ...
    headings: ["How much does a dental bone graft cost?","Bone graft prices depend on the graft type and quoted site","Autograft, allograft, xenograft and alloplast are different quote categories","Is the bone graft included in an implant or extraction quote?","What can change the bone graft quote?","How insurance can affect the patient cost","What this page does not price or decide","Related dental procedure pages"],
  },
  {
  ...
  },
  {
    ...
    headings: ["All-on-4 dental implants cost calculator","How much do All-on-4 dental implants cost?","What does All-on-4 mean in a dental quote?","Is an All-on-4 price per arch or for a full mouth?","What may be included in an All-on-4 package?","What changes an All-on-4 quote?","How insurance can affect out-of-pocket cost","All-on-4 vs. generic full-arch implant quotes","Related dental implant pages"],
  },
  {
